...
describe('VideoController', () => {
  ...
  beforeEach(() => {
    ...
    // Mock prototype methods with correct `this` typing
    vi.spyOn(window.HTMLMediaElement.prototype, 'load').mockImplementation(() => {})
    vi.spyOn(window.HTMLMediaElement.prototype, 'play').mockImplementation(async function(this: HTMLVideoElement) {
      await Promise.resolve()
      this.dispatchEvent(new Event('play'))
    })
    vi.spyOn(window.HTMLMediaElement.prototype, 'pause').mockImplementation(function(this: HTMLVideoElement) {
  ...
  describe('Basic controls', () => {
    it('should play video when play() is called', async () => {
      ...
      // Simulate video being ready to play, which might be what the controller awaits
